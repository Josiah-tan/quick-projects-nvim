...
- Firstly, get telescope and its own dependencies
...
- create a folder structure that looks like this (note the use of .txt files):
...
- now type something and you will see the directory that you want pop up in the options
  	- for example, using my [[#creating-project-paths][folder structure]]
