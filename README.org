...
- It is designed specifically for tmux
	- there is partial support for linux terminals, but this is deprecated
...
- I recommend learning from this [[https://github.com/nanotee/nvim-lua-guide#where-to-put-lua-files][website]].
